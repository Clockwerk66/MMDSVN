...
label SeaMain:
    ...
    if povName == 'Dev':
       ...
       Dev "[SeaMG] Data: Size=[SeaMGD.Size], BSize=[SeaMGD.BSize], HasHands=[SeaMGD.HasHands], HasWings=[SeaMGD.HasWings], HasLegs=[SeaMGD.HasLegs], HasTail=[SeaMGD.HasTail], HasScales=[SeaMGD.HasScales], CanSwim=[SeaMGD.CanSwimLong], CanFly=[SeaMGD.CanFly], IsColdB=[SeaMGD.IsColdB], CanWeb=[SeaMGD.CanWeb], HasGills=[SeaMGD.HasGills], CanShapeshift=[SeaMGD.CanShapeshift]."
